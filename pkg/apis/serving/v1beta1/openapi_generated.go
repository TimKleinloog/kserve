		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"model": {
						SchemaProps: spec.SchemaProps{
							Description: "Explainer spec for any arbitrary framework.",
